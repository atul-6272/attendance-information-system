...
$username=$_SESSION['emplogin'];
    $sql ="SELECT Password FROM tbl_employees WHERE EmpId=:username and Password=:password";
...
if($query -> rowCount() > 0)
{
$con="update tbl_employees set Password=:newpassword where EmpId=:username";
