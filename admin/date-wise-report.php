      ...
      <body>  
           ...
           <div class="container" style="width:1200px;">  
				...
				<div style="padding-left:15px; margin-bottom:8px;">  
                     <button type="submit"  value="DATE WISE REPORT" class="btn btn-info"  style="width:20%; font-size:16px;" onclick="location.href='date-wise-report.php'"> DATE WISE REPORT </button> <span></span>
              
				<span style="padding-left:15px; margin-bottom:8px;">  
                    <button type="submit"class="btn btn-info"  style="width:20%; font-size:16px;" onclick="location.href='employee-wise-report.php'"> EMPLOYEE WISE REPORT </button> <span></span>
