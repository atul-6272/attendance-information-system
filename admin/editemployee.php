...
$sql="update tbl_employees set FirstName=:fname,LastName=:lname,Gender=:gender,Dob=:dob,Department=:department,Address=:address,City=:city,Country=:country,Phonenumber=:mobileno,Reportingofficer=:reportingofficer, Project=:project, DOJ=:doj,DOE=:doe where id=:eid";
...
$query->bindParam(':doe',$doe,PDO::PARAM_STR);
$query->bindParam(':reportingofficer',$reportingofficer,PDO::PARAM_STR);
...
<br><label for="empcode">Employee Code(Must be unique)</label>
...
<input id="reportingofficer" name="reportingofficer" type="text" value="<?php echo htmlentities($result->Reportingofficer);?>" autocomplete="off" required>
</div>

<div class="input-field col m6 s12">
<label for="projectname">Project Name</label><br>
<input id="projectname" name="projectname" type="text" value="<?php echo htmlentities($result->Project);?>" autocomplete="off" required>
</div>
...
<input id="dateofjoin" name="doj"  value="<?php echo htmlentities($result->DOJ);?>" class="datepicker"  >
</div>

<div class="input-field col m6 s12">
<label for="dateofexit">Date of Exit</label><br>
<input id="dateofexit" name="doe"  value="<?php echo htmlentities($result->DOE);?>" class="datepicker"  >
</div>
