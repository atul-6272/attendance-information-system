...
$doj=$_POST['doj'];
$doe=$_POST['doe'];
$sql="update tbl_employees set FirstName=:fname,LastName=:lname,Gender=:gender,Dob=:dob,Department=:department,DOJ=:doj,DOE=:doe,Address=:address,City=:city,Country=:country,Phonenumber=:mobileno where id=:eid";
