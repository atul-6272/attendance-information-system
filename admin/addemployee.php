...
$sql="INSERT INTO tbl_employees(EmpId,FirstName,LastName,EmailId,Password,Gender,Dob,Department,DOJ,DOE,Reportingofficer,Project,Address,City,Country,Phonenumber,Status) VALUES(:empid,:fname,:lname,:email,:password,:gender,:dob,:department,:doj,:doe,:reportingofficer,:project,:address,:city,:country,:mobileno,:status)";
...
<input id="reportingofficer" name="reportingofficer" type="text" autocomplete="off" required>
</div>

<div class="input-field col m6 s12">
<label for="projectname">Project Name</label>
<input id="projectname" name="projectname" type="text" autocomplete="off" required>
</div>
...
<input id="dateofjoin" name="doj" type="date" class="datepicker" autocomplete="off" >
</div>

<div class="input-field col m6 s12">
<label for="dateofexit">Date of Exit</label>
<input id="dateofexit" name="doe" type="date" class="datepicker" autocomplete="off" >
</div>
