   ...
   <li class="no-padding">
                        <a class="collapsible-header waves-effect waves-grey">Report Management </a>
                        <div class="collapsible-body">
                            <ul>
                                <li><a href="employee-report.php">Employee Report</a></li>
                                <li><a href="date-wise-report.php">Attendance Report</a></li>
...
<li class="no-padding"><a class="waves-effect waves-grey" href="changepassword.php">Change Password</a></li>
