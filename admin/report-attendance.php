...
td{ font-size:16px;}
      ...
      <body>  
			...
			<div class="header" style="background-color:#00acc1; height:50px; width:100%;">
				...
				<span style="float:right; color:black;"> <a href="dashboard.php"><button>BACK</button></a></span></p>
			</div>
           ...
           <div class="container" style="width:1200px;">  
				...
				<div style="padding-left:15px; margin-bottom:8px;">  
                     <a href="employee-report.php"><button type="submit"  value="DATE WISE REPORT" class="btn btn-info"  style="width:20%; font-size:16px;"> DATE WISE REPORT </button></a> <span></span>
              
				<span style="padding-left:15px; margin-bottom:8px;">  
                    <a href="report-attendance.php"><button type="submit"class="btn btn-info" onclick="report-attend.php" style="width:20%; font-size:16px;"> EMPLOYEE WISE REPORT </button></a> <span></span>
