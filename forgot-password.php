...
$con="update tbl_employees set Password=:newpassword where id=:empid";
...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>AIS | Password Recovery</title>
                ...
                <nav class="cyan darken-1">
                    <div class="nav-wrapper row">
                        ...
                        <div class="header-title col s3">      
                            <span class="chapter-title">AIS| Attendance Information System</span>
                        </div>
...
$empid=$_POST['empid'];
$email=$_POST['emailid'];
$sql ="SELECT id FROM tbl_employees WHERE EmailId=:email and EmpId=:empid";
...
foreach ($results as $result) {
 ...
 <div class="row">
          <span class="card-title" style="font-size:20px; marging-left:10px;">change your password </span>                                     
